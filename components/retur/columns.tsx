...
export const columns: ColumnDef<ReturPembelianType>[] = [
  // Nomor Urut
  {
    id: "no",
    header: "No.",
  ...
  {
    id: "buktiPengiriman",
    header: "Bukti Pengiriman Barang",
    columns: [
      {
        accessorKey: "NomorSuratJalan",
        header: "Nomor",
        cell: ({ row }) => {
          const value = row.getValue("NomorSuratJalan") as number;
          return value || "-";
        },
      },
      {
        ...
        header: "Tanggal",
        cell: ({ row }) => formatDate(row.getValue("TanggalSuratJalan")),
      },
      {
        accessorKey: "PembeliPeneima",
        header: "Pembeli/Penerima",
        cell: ({ row }) => {
          const value = row.getValue("PembeliPeneima") as string;
          return (
